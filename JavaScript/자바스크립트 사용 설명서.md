...
var p1 = new Person("Hyunwoo"); //this == p1
p1.name // => "Hyunwoo"
...
var p1 = new Person('Hyunwoo');
var p2 ={};
//call 예시1
Person.call(p2, "Hyunwoo"); //call(this, arguments)
p2 // {name: "Hyunwoo"}
...
//call 예시2
Person.call(p3, 'Hyunwoo', 33)
p3 // {name: 'Hyunwoo', age: 33}
...
Person.call(p3, 'Hyunwoo', 33) //,로 구분해서 인자들을 전해줌.
Person.apply(p3, ["Hyunwoo", 33]) //배열 안에 몽땅 넣어서 전해줌.
